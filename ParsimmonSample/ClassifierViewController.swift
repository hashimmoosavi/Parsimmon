...
class ClassifierViewController: UIViewController {
    ...
    fileprivate func train() {
        ...
        let closeworkorder = ["Close work order", "Finish work order", "Close. I am done", "Terminate the work order", "I am done"]
        
        for sentence in closeworkorder {
            
            let trainingsentence = filteredSentence(sentence: sentence)
            
            //print(trainingsentence + " for work detail ")
            
            classifier.trainWithText(trainingsentence, category: "closeworkorder")
        }
        ...
        let greeting =  ["Hello hello", "Hi hi", "Howdy howdy", "Yo yo", "Good morning"]
        ...
        let starttravel = ["Can we start travel", "Please let the travel begin", "Start travel", "Begin travel", "Let us travel"]
